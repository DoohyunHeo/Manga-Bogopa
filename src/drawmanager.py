...
def create_mask(image, boxes, target_classes, class_names, padding=0):
    ...
    for box in boxes:
        ...
        if class_name in target_classes:
            ...
            padded_x1, padded_y1 = x1 - padding, y1 - padding
            padded_x2, padded_y2 = x2 + padding, y2 + padding
            cv2.rectangle(mask, (padded_x1, padded_y1), (padded_x2, padded_y2), (255, 255, 255), -1)
    return mask
